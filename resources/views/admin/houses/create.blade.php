...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.houses.create-house') }}" enctype="multipart/form-data">
        @csrf
        @error('formError')
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('title') is-invalid @enderror" name="description" rows="3" id="description">{{ old('description') }}</textarea>
            @error('description')
            <span class="invalid-feedback fadeInLeft" role="alert">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="rooms" value="{{ old('rooms') }}" class="form-control @error('rooms') is-invalid @enderror" id="rooms">
            @error('rooms')
            <span class="invalid-feedback fadeInLeft" role="alert">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="price_per_day" value="{{ old('price_per_day') }}" class="form-control @error('price_per_day') is-invalid @enderror" id="price-per-day">
            @error('price_per_day')
            <span class="invalid-feedback fadeInLeft" role="alert">{{ $message }}</span>
            @enderror
        </div>
